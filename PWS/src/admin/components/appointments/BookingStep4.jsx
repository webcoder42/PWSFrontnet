...
const BookingStep4 = ({ onBackToDashboard, onReschedule }) => (
  <div className="animate-in fade-in zoom-in-95 duration-700">
    <div className="mb-8">
      ...
      <p className="text-gray-400 text-sm">Review the assignment details below</p>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-12">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-purple-600 rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl shadow-purple-100">
            ...
            <p className="text-purple-100 text-[10px] mb-4 leading-relaxed">Need help with bulk scheduling or complex assignments? Reach out anytime.</p>
