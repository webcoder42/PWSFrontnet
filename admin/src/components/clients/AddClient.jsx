...
const AddClient = ({ formData, setFormData, onAdd, onCancel }) => (
  <div className="animate-in slide-in-from-bottom-4 duration-500 max-w-2xl">
     ...
     <div className="bg-white p-10 rounded-[2.5rem] border border-gray-50 shadow-sm">
       <h3 className="text-2xl font-bold mb-8 font-serif">Register New Client</h3>
       <div className="space-y-6">
          ...
          <button onClick={onAdd} className="w-full py-5 bg-purple-600 text-white rounded-2xl font-bold text-sm shadow-xl shadow-purple-100 uppercase tracking-widest hover:-translate-y-1 transition-all">Create Client Record</button>
       </div>
     </div>
  </div>
);
