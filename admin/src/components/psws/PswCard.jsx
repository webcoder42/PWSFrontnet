...
const PswCard = ({ psw, onViewProfile, onAssignTask }) => (
  <div className="bg-white p-8 rounded-[2.5rem] border border-gray-50 shadow-sm group hover:-translate-y-1 transition-all">
    <div className="flex justify-between items-start mb-6">
      <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${psw.seed}`} className="w-20 h-20 rounded-2xl shadow-md border-4 border-white group-hover:scale-105 transition-transform" alt={psw.name} />
