            ...
            {!isSidebarCollapsed && (
              <>
                <div className="flex-1 min-w-0 animate-fade-in">
                  <p className="text-sm font-bold truncate">{userFullName}</p>
                </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-20 flex-shrink-0 bg-white/50 backdrop-blur-sm border-b border-gray-100 flex items-center justify-between px-4 md:px-10 z-10">
          ...
          <div className="flex items-center space-x-4 md:space-x-6">
            ...
            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Jack" alt="Profile" className="w-10 h-10 rounded-xl shadow-md border-2 border-white flex-shrink-0" />
          </div>
        </header>
