...
const Messages = () => {
  ...
  return (
    <div className="h-[calc(100vh-140px)] flex bg-white rounded-[2rem] border border-gray-50 shadow-sm overflow-hidden animate-in fade-in duration-700">
      ...
      <div className="flex-1 flex flex-col h-full bg-gray-25/30 relative">
        <div
        ...
        {!selectedKey ? (
          ...
          <>
            <div className="p-6 border-b border-gray-50 flex justify-between items-center bg-white/80 backdrop-blur-md sticky top-0 z-10 shadow-sm">
            ...
            <div ref={chatContainerRef} className="flex-1 overflow-y-auto p-8 space-y-6 relative">
              {loadingChat ? (
            ...
            <form
              onSubmit={handleSend}
              className="p-6 bg-white border-t border-gray-50 flex items-center space-x-4"
            >
