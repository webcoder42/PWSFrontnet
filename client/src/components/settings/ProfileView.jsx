...
const ProfileView = ({ setView }) => {
  ...
  const userRole = 'Senior Clinical Administrator';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
      <div className="lg:col-span-4 space-y-6">
         <div className="bg-white rounded-[2.5rem] border border-gray-50 shadow-sm p-10 flex flex-col items-center text-center">
            ...
            <p className="text-[10px] font-bold text-purple-600 uppercase tracking-widest mb-10">{userRole}</p>
            ...
            <div className="w-full space-y-6 text-left">
               ...
               <div className="flex items-start gap-4">
                  ...
                  <div><p className="text-[8px] font-bold text-gray-400 uppercase tracking-widest">Address</p><p className="text-sm font-bold text-gray-800 max-w-[150px]">123 Main St, Brampton, ON</p></div>
               </div>
            </div>
         </div>
      ...
      <div className="lg:col-span-8 bg-white rounded-[2.5rem] border border-gray-50 shadow-sm p-12">
         ...
         <div className="space-y-10">
            ...
            <div className="space-y-4 pt-4 border-t border-gray-25">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                     ...
                     <input type="text" defaultValue="Ava Miller" className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-medium focus:bg-white focus:border-purple-100 transition-all outline-none" />
                  </div>
                  <div className="space-y-2">
                     <label className="text-[8px] font-bold text-gray-500 uppercase tracking-widest ml-1">Phone Number</label>
                     <input type="text" defaultValue="(123) 456-7890" className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-medium focus:bg-white focus:border-purple-100 transition-all outline-none" />
                  </div>
               </div>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-25">
               ...
               <div className="space-y-6">
                  <div className="space-y-2">
                     ...
                     <input type="text" defaultValue="123 Queen St." className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-medium focus:bg-white focus:border-purple-100 transition-all outline-none" />
                  </div>
                  <div className="space-y-2">
                     <label className="text-[8px] font-bold text-gray-500 uppercase tracking-widest ml-1">City</label>
                     <input type="text" defaultValue="Toronto" className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-medium focus:bg-white focus:border-purple-100 transition-all outline-none" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                     <div className="space-y-2">
                        <label className="text-[8px] font-bold text-gray-500 uppercase tracking-widest ml-1">Province</label>
                        <select className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-medium focus:bg-white focus:border-purple-100 transition-all outline-none appearance-none cursor-pointer"><option>Ontario</option><option>Quebec</option></select>
                     </div>
                     <div className="space-y-2">
                        <label className="text-[8px] font-bold text-gray-500 uppercase tracking-widest ml-1">Postal code</label>
                        <input type="text" defaultValue="M5H 2N2" className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-medium focus:bg-white focus:border-purple-100 transition-all outline-none" />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="flex justify-end gap-6 pt-10 mt-6 border-t border-gray-25">
               ...
               <button onClick={() => setView('main')} className="flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-purple-700 to-purple-500 text-white rounded-2xl font-bold text-sm shadow-xl shadow-purple-200 hover:-translate-y-1 transition-all"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"/></svg> Save Changes</button>
            </div>
         </div>
      </div>
    </div>
